...
export const AdminReportsPage: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    exportToCSV(`whitehouse_admin_reports_${Date.now()}.csv`, data);
    showToast('Exported admin report matrix to CSV!', 'success');
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">
            Household settlement matrix, contributions, and category analytics
          </p>
        </div>
      ...
      <Card className="p-0 overflow-hidden">
        <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
          <CardTitle>Member Settlement & Contribution Table</CardTitle>
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-slate-50/80 border-b border-slate-200/80 text-[11px] font-bold uppercase tracking-wider text-slate-500">
              <tr>
                ...
                <th className="py-3.5 px-4 text-right">% Contribution</th>
